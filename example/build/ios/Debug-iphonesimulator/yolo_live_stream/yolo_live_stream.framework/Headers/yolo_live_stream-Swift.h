...
#ifndef YOLO_LIVE_STREAM_SWIFT_H
#define YOLO_LIVE_STREAM_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="yolo_live_stream",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC16yolo_live_stream20YoloLiveStreamPlugin")
@interface YoloLiveStreamPlugin : NSObject <FlutterPlugin>
