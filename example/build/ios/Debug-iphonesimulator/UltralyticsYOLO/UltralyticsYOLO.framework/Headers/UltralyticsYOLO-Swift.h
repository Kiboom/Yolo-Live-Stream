...
#ifndef ULTRALYTICSYOLO_SWIFT_H
#define ULTRALYTICSYOLO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="UltralyticsYOLO",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC15UltralyticsYOLO12VideoCapture")
...
@interface VideoCapture (SWIFT_EXTENSION(UltralyticsYOLO)) <AVCaptureVideoDataOutputSampleBufferDelegate>
- (void)captureOutput:(AVCaptureOutput * _Nonnull)output didOutputSampleBuffer:(CMSampleBufferRef _Nonnull)sampleBuffer fromConnection:(AVCaptureConnection * _Nonnull)connection;
@end

/// Handles downloading and processing of YOLO models from remote URLs.
SWIFT_CLASS("_TtC15UltralyticsYOLO19YOLOModelDownloader")
@interface YOLOModelDownloader : NSObject
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
@end
...
@interface YOLOModelDownloader (SWIFT_EXTENSION(UltralyticsYOLO)) <NSURLSessionDownloadDelegate>
...
SWIFT_CLASS("_TtC15UltralyticsYOLO8YOLOView")
