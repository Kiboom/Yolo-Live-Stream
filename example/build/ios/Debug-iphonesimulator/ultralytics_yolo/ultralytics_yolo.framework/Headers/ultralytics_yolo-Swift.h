...
#ifndef ULTRALYTICS_YOLO_SWIFT_H
#define ULTRALYTICS_YOLO_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ultralytics_yolo",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIView;
@class FlutterError;
SWIFT_CLASS("_TtC16ultralytics_yolo21SwiftYOLOPlatformView")
@interface SwiftYOLOPlatformView : NSObject <FlutterPlatformView, FlutterStreamHandler>
...
@protocol NSObject;
SWIFT_CLASS("_TtC16ultralytics_yolo28SwiftYOLOPlatformViewFactory")
@interface SwiftYOLOPlatformViewFactory : NSObject <FlutterPlatformViewFactory>
...
SWIFT_CLASS("_TtC16ultralytics_yolo10YOLOPlugin")
@interface YOLOPlugin : NSObject <FlutterPlugin>
...
SWIFT_CLASS("_TtC16ultralytics_yolo8YOLOView")
@interface YOLOView : UIView
